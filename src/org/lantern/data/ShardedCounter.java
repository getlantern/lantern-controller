...
public class ShardedCounter {
    ...
    public long getCount() {
        ...
        if (cache != null) {
            cache.put("count" + counterName, new Long(sum));
        }
    ...
    public void increment(long count) {
        if (cache != null) {
            ...
            if (cachedCount != null) {
                cache.put("count" + counterName,
                        new Long(count + cachedCount.longValue()));
            }
        }
        ...
        try {
            ...
            randomShardQuery
                    .setFilter("counterName == nameParam && shardNumber == numParam");
            randomShardQuery
                    .declareParameters("String nameParam, int numParam");
            List<DatastoreCounterShard> shards = 
