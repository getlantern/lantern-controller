...
public class ExtendedJob extends HttpServlet {
    ...
    public void doPost(final HttpServletRequest request,
        ...
        ArrayList<String> args = parseArgs(request);
        try {
    ...
    protected ArrayList<String> parseArgs(HttpServletRequest request) {
        String rawArgs = request.getParameter(ARGS);
        if (rawArgs == null) {
            return new ArrayList<String>();
        } else {
            return new ArrayList(Arrays.asList(rawArgs.trim().split(separator)));
        }
    }

    protected String serializeArgs(ArrayList<String> args) {
